    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-12">
                ...
                <!-- Color Start -->
                <div class="border-bottom mb-4 pb-4">
                    <h5 class="font-weight-semi-bold mb-4">Chất liệu</h5>
                    <form>
                        @if ($materials)
                ...
                <div class="mb-5">
                    <h5 class="font-weight-semi-bold mb-4">Định lượng</h5>
                    <form>
                    ...
                    @foreach ($products as $product)
                        <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                            <div class="card product-item border-0 mb-4">
                                <div width="420px" height="420px"
                                    class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                    <img class="img-fluid w-100 image-cover"
                                        src="{{ asset('storage') . '/' . $product->image }}"
                                        alt="{{ $product->name }}" width="420px" height="420px">
                                </div>
