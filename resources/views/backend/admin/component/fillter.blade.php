        ...
        <div class="uk-flex uk-flex-middle uk-flex-space-between">
            ...
            <div class="action">
                <div class="uk-flex uk-flex-middle">
                    @php
                        $publishValue = ['unPublish', 'Publish'];
                        $publish = request('publish') !== null ? request('publish') : old('publish', -1);
                    @endphp

                    <select name="publish" class="form-control mr10 setupSelect2">
                        <option value="-1" selected="selected">Kích hoạt</option>
                        @foreach ($publishValue as $key => $val)
                    ...
                    <a href="{{ route('admin.users.create') }}" class="btn btn-danger"><i
