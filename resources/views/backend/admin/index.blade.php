            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        @include('backend.admin.component.tollbox')
                    </div>
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                @include('backend.admin.component.fillter')
                                                    ...
                                                    <td>
                                                        <label class="switch">
                                                            <input type="checkbox"
                                                                ...
                                                                data-field="publish" data-model="User"
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center list-action action">
                                                            <a class="badge-info mr-2 btn p-2 d-flex btn-action data-toggle="tooltip"
                                                                ...
                                                                href="{{ route('admin.catelogue.edit', $item->id) }}"><i
                                                                    class="fa fa-pencil" aria-hidden="true"></i></a>
                                                            <a class="badge-danger d-flex btn p-2 btn-action" data-toggle="tooltip"
                                                                data-placement="top" title=""
                                                                data-original-title="View"
                                                                href="{{ route('admin.catelogue.show', $item->id) }}"><i
