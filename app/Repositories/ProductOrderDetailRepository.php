...
use App\Models\Product_Order_detail;
use App\Repositories\Interface\ProductOrderDetailRepositoryInterface;

class ProductOrderDetailRepository extends BaseRepository implements ProductOrderDetailRepositoryInterface
{
    protected $model;
    public function __construct(Product_Order_detail $model)
    {
        $this->model = $model;
    }
