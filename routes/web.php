...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::Post('/login', [AuthController::class, 'postLogin'])->name('post.login')->middleware('guest:admin');
    Route::get('/', [DashboardController::class, 'index'])->name('index')->middleware('auth:admin');
